...
import 'package:unetpedia/ui/qualifications/widgets/grade_input_row.dart';
import 'package:unetpedia/ui/qualifications/cubit/qualification_cubit.dart';
...
class QualificationView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Scaffold(
        appBar: const MainAppBar(title: "Calcula tu Nota", isWhite: true),
        body: _View(),
      ),
    );
  }
...
class __ViewState extends State<_View> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<QualificationCubit>().initializeGrades(3);
    });
  }
                    ...
                    children: [
                      ...
                      ...state.grades.asMap().entries.map((entry) {
                        ...
                        return GradeInputRow(
                          ...
                          onGradeChanged: (index, {score, percentage}) {
                            context.read<QualificationCubit>().updateGrade(
                              index,
                              score: score,
                          ...
                          onRemove: () {
                            context.read<QualificationCubit>().removeGrade(
                              index,
                            );
                          },
                        );
                      ...
                      Center(
                        child: OutlinedButton.icon(
                          onPressed: () {
                            context.read<QualificationCubit>().addGrade();
                          },
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                                ...
                                children: [
                                  ...
                                  Text(
                                    ...
                                    style: TextStyle(
                                      ...
                                      color:
                                          state.calculation.totalPercentage ==
                                              100.0
                                          ? Colors.green
                                          : state.calculation.totalPercentage >
                                                100.0
                              ...
                              if (state.calculation.remainingPercentage >
                                  0) ...[
                                const SizedBox(height: 16),
                                const Divider(),
                                const SizedBox(height: 16),
                  ...
                  children: [
                    Expanded(
                      child: OutlinedButton(
                        onPressed: () {
                          context.read<QualificationCubit>().resetCalculator();
                          context.read<QualificationCubit>().initializeGrades(
                            3,
                          );
                        },
